...
local function SkinScrollBar(frame, thumbTrim)
	...
	if uScroll and dScroll then
		...
		if not frame.trackbg then
			-- track:Point("TOPLEFT", uScroll, "TOPLEFT", 0, 0)
			-- track:Point("BOTTOMRIGHT", dScroll, "BOTTOMRIGHT", 0, 0)
			frame.trackbg = CreateFrame("Frame", nil, frame)
			frame.trackbg:Point("TOPLEFT", uScroll, "TOPLEFT", 0, 0)
			frame.trackbg:Point("BOTTOMRIGHT", dScroll, "BOTTOMRIGHT", 0, 0)
		...
		if frame:GetThumbTexture() then
			...
			if not frame.thumbbg then
				...
				frame.thumbbg:Point("TOPLEFT", frame:GetThumbTexture(), "TOPLEFT", 2, 14)
				frame.thumbbg:Point("BOTTOMRIGHT", frame:GetThumbTexture(), "BOTTOMRIGHT", -2, -14)
...
local function LoadWindow()
	if not stAddonManager.Loaded then
		...
		scrollFrame:Point("TOPLEFT", header, "TOPLEFT", 10, -50)
		...
		for i, addon in pairs(stAddonManager.AllAddons) do
			...
			button.text:Point("RIGHT", scrollFrame.Anchor, "RIGHT", 0, 0)
